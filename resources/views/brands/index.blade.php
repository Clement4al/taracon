        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form x-data @submit.prevent="$submit()" action="{{ route('api.brands.store') }}" method="POST" @then="location.reload()" enctype="multipart/form-data">
    ...
    <div class="modal fade" id="edit-brand" tabindex="-1" aria-labelledby="edit-brand-label" aria-hidden="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  @submit.prevent="$submit()" @then="location.reload()" enctype="multipart/form-data"
                           :action="action" x-data="{ brand: {}, action: null }"
                           @editing.window="{ brand, action } = $event.detail"
                           @then="$dispatch(`update${brand.id}`, { brand: brand })"
                    >
                        @method('PUT')
                        <div class="card card-flush py-4">
                            <div class="card-header">
