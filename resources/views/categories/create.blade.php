        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid " >
                ...
                <div id="kt_app_content_container" class="app-container  container-xxl ">
                    <form x-data @submit.prevent="$submit()" class="form d-flex flex-column flex-lg-row" action="{{ route('api.categories.store') }}" method="POST" @then="location.reload()" enctype="multipart/form-data">
