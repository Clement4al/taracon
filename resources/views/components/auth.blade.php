...
<head>
    ...
    <meta name="author" content="Clement Michael - 08163882870">
...
<div class="d-flex flex-column flex-root" id="kt_app_root">
    <div class="d-flex flex-column flex-lg-row flex-column-fluid">
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center"
             style="background-image: url('{{ asset('admin/media/misc/auth-real.png ') }}')">
            <!--begin::Content-->
            <div class="d-flex flex-column p-6 p-lg-10 w-100">
                <!--begin::Logo-->
                <a href="{{ route('home') }}" class="mb-0 mt-10 pt-5 mb-lg-20 text-center">
                    <span class="text-white" style="font-size: 50px; font-family: sans-serif; font-weight: 800">Taracon<span class="text-warning">.</span></span>
                </a>
                <!--end::Logo-->
                <!--begin::Image-->
                <img class="d-none d-lg-block mx-auto w-300px w-lg-75 w-xl-500px mb-10 mb-lg-20" src="{{ asset('images/resources/fashion.png') }}" alt=""/>
                <!--end::Image-->
                <!--begin::Title-->
...
{{--                </div>--}}
                <div class="d-none d-lg-block text-white fs-base text-center">
                    Nourish your body with <span class="text-warning">fresh, safe, and natural</span> food choices.<br>
                    Get <span class="text-warning">carefully sourced, top-quality</span> edible products at taracon store.<br>
                    Eat better, live better — <span class="text-warning">every single day.</span>
                </div>
        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
            ...
            <!--begin::Footer-->
            <div class="d-flex flex-center text-success flex-wrap px-5">
                <!--begin::Links-->
                <div class="d-flex fw-semibold text-success fs-base">
                    <a href="{{ route('home') }}" class="px-5 text-success">Home</a>
                    <a href="{{ route('about-us') }}" class="px-5 text-success">About Us</a>
                    <a href="{{ route('contact-us') }}" class="px-5 text-success">Contact Us</a>
                </div>
                <!--end::Links-->
            </div>
            <!--end::Footer-->
