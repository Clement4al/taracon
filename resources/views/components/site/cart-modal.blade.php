                                ...
                                <li class=list_content>
                                    <div>
                                        ...
                                        <div class="cart_btn home_page_sidebar mt10">
                                            <form action="{{ route('api.products.cart.update', $product) }}" x-data @submit.prevent="$submit()" @change="$dispatch('submit')">
                                                @method('PUT')
                                        ...
                                        <form action="{{ route('api.products.cart.destroy', $product) }}" x-data @submit.prevent="$submit()" data-confirm method="POST">
                                            @method('DELETE')
