<div class="row">
                    ...
                    <div class="card-header align-items-center py-5">
                        <div class="card-title ms-5">
                            <div class="d-flex align-items-center position-relative my-1 w-100">
                                ...
                                <input type="text" id="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Products" aria-label="search" wire:model.live="search">
                            </div>
                        </div>
                        <div class="card-toolbar me-5">
                            <div class="ms-5 position-relative my-1" wire:ignore>
                                <select class="form-select form-select-solid w-250px ps-14" aria-label="Category" wire:model.live="subCategory">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="mt-3">
                                        <form action="{{ route('api.products.cart.store', $product) }}" method="post"
                                              @submit.prevent="$submit()" wire:then="$refresh" data-quietly
                                        >
            ...
            <div class="card-header pt-5">
                ...
                <div class="card-toolbar">
                    <form
                        ...
                        x-data @submit.prevent="$submit()" wire:then="$refresh" method="POST"
                    >
                        @method('delete')
                        <button
                            type="submit" class="btn btn-sm btn-light-primary fw-bold"
                            ...
                            <tr data-kt-pos-element="item" data-kt-pos-item-price="33">
                                ...
                                <td class="text-end">
                                    <form action="{{ route('api.products.cart.destroy', $product) }}"
                                          @submit.prevent="$submit()" method="POST" wire:then="$refresh" data-quietly
                                    >
                                        @method('delete')
    ...
    <div wire:ignore class="modal fade" id="checkout-modal" tabindex="-1" aria-labelledby="checkout-label" aria-hidden="false">
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body" x-data="{ type : 'pickup', user : 'existing' }">
                    <form @submit.prevent="$submit()" action="{{ route('api.pos.store') }}" id="checkout-form" method="POST">
                        ...
                        <div class="row mb-10" x-show="user === 'existing'">
                        ...
                        <div class="row mb-10" x-show="user === 'new'">
