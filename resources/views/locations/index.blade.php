                                    ...
                                    @foreach($locations as $location)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                {{ number_format($location->stock_quantity) }}
                                            </td>
                                            <!--end::Type--->
                                            <!--begin::Type--->
                                            <td class="text-center">
                                                {{ number_format($location->stock_value) }}
                                            </td>
                                            <td class="text-center">
                                                {{ number_format($location->cost_value) }}
                                            </td>
                                            <td class="text-center">
                                                {{ number_format($location->stock_value - $location->cost_value) }}
                                            </td>
                                            <td>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form x-data @submit.prevent="$submit()" action="{{ route('api.locations.store') }}" id="add-location" method="POST" @then="location.reload()">
                        <div class="mb-10">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body" x-data="{ location : {}, action : {} }" @editing.window="location = $event.detail.location; action = $event.detail.action">
                    <form @submit.prevent="$submit()" :action="action" method="POST" @then="location.reload()">
                        @method('put')
                        <div class="mb-10">
