    ...
    <table align="center" style="background:none; border:none; margin: auto;">
        <tr style="background:none; border:none; ">
            ...
            <td style="background:none; border:none; text-align: center">
                <h1>Taracon.</h1>
                <p><br>YOUR NO. 1 ONLINE PRODUCT SHOP</p>
                E-mail: <a href="mailto:info@taraconsupport.com">info@taraconsupport.com</a>
            </td>
            <td style="background:none; border:none;"></td>
        </tr>
    </table>
    <div style="text-align:center;">
        <h3 style="border: 2px solid #084c17; padding: 5px">INVOICE #{{ $order->id }}</h3>
    </div>
    <br>
    <table align="center" style="background:none; border:none; margin: auto;">
        <tr style="background:none; border:none; ">
            <td style="background:none; border:none;">
                <p><b>Taracon Headquarters</b><br>10B PRIME ROSE AVENUE,<br>IKOTA GRA.<br>IKOTA, LAGOS <br><br></p>
            ...
            <td style="background:none; border:none; text-align: right">
                <img src="{{ qr(route('orders.show', $order)) }}" alt="qr-code">
                @unless($order->isPaid())
