        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid " >
                ...
                <div id="kt_app_content_container" class="app-container  container-xxl">
                    <form x-data @submit.prevent="$submit()" class="form d-flex flex-column flex-xl-row" action="{{ route('api.products.store') }}" method="POST">
                        <!--begin::Aside column-->
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div class="input-group mb-2 w-50 pe-5">
                                                <input type="number" name="discount" class="form-control" placeholder="0" required aria-label="discount">
                                                <span class="input-group-text">%</span>
                                            </div>
                                            <div class="text-muted fs-7">Optional</div>
                                        </div>
                                    </div>
                                </div>
                                <!--end::Pricing-->
