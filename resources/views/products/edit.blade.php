            ...
            <div id="kt_app_content" class="app-content  flex-column-fluid " >
                ...
                <div id="kt_app_content_container" class="app-container  container-xxl">
                    ...
                    <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
                        ...
                        <!--end:::Tabs-->
                        @can('manage-shop')
                            <form x-data @submit.prevent="$submit()" action="{{ route('api.products.destroy', $product) }}" data-confirm>
                                @method('delete')
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="generalTab">
                            ...
                            <!--begin::Form-->
                            <form
                                action="{{ route('api.products.update', $product) }}"
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="mb-10 fv-row">
                                                    ...
                                                    <div class="input-group mb-2 w-50 pe-5">
                                                        <input type="number" name="discount" class="form-control" placeholder="0" value="{{ $product->discount }}" required aria-label="discount">
                                                        <span class="input-group-text">%</span>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form @submit.prevent="$submit()" action="{{ route('api.stock.store') }}" x-data @then="location.reload()">
