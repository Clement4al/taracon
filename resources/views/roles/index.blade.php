                            ...
                            <div class="col-md-4">
                                <div class="card card-flush h-md-100">
                                    ...
                                    <div class="card-footer flex-wrap pt-0">
                                        ...
                                        <form x-data @submit.prevent="$submit()" id="delete-role-form" action="{{ route('api.roles.destroy', $role) }}" method="POST" @then="location.reload()" data-confirm="Are you sure you want to delete this role?">
                                            @method('delete')
                                        </form>
                                    </div>
                                </div>
        ...
        <div class="card shadow-none rounded-0 w-100">
            ...
            <div class="card-body" id="add-role-body">
                ...
                <div id="kt_explore_scroll" class="scroll-y me-n5 pe-5" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-wrappers="#add-role-body" data-kt-scroll-dependencies="#add-role-header" data-kt-scroll-offset="5px">
                    <!--begin::Wrapper-->
                    <div class="mb-0">
                        <form x-data @submit.prevent="$submit()" action="{{ route('api.roles.store') }}" id="add-role-form" method="POST" @then="location.reload()">
                            <div class="mb-10">
