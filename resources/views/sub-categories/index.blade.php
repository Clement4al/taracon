                                            ...
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form x-data @submit.prevent="$submit()" action="{{ route('api.sub-categories.update', $subCategory) }}" id="edit-sub-category-{{ $subCategory->id }}-form" method="POST" @then="location.reload()">
                                                            @method('PUT')
                                                            <div class="mb-10">
    ...
    <div class="modal fade" id="add-sub-category-modal" tabindex="-1" aria-labelledby="add-sub-category-modal-label" aria-hidden="false">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form x-data @submit.prevent="$submit()" action="{{ route('api.sub-categories.store') }}" id="add-sub-category" method="POST" @then="location.reload()">
                        <div class="mb-10">
