                ...
                <div id="kt_app_content_container" class="app-container  container-xxl ">
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-0">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-circle symbol-35px overflow-hidden me-2">
                                                        <a href="{{ route('users.show', $transfer->author) }}">
                                                            <div class="symbol-label">
                                                                <img src="{{ $transfer->author->photo }}" alt="{{ $transfer->author->name }}" class="w-100" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <div class="ms-5">
                                                        <a href="{{ route('users.show', $transfer->author) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold">
                            ...
                            {{ $transfers->onEachSide(1)->withQueryString()->links() }}
                        </div>
                    </div>
                </div>
