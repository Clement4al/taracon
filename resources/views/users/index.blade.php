                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-sm btn-primary me-3" data-bs-toggle="modal" data-bs-target="#createUser">
                                        Register {{ str($type)->singular() }}
                                    </button>
                                ...
                                <tbody class="fw-semibold text-gray-600">
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('users.show', $user) }}" class="text-gray-600 text-hover-primary mb-1">
                                                    {{ $user->email ?? '-' }}
                                                </a>
                                            </td>
                                            @if (request()->type === 'admin')
                    ...
                    <div class="modal fade" id="createUser" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <form x-data @submit.prevent="$submit()" action="{{ route('api.users.store') }}">
