                        ...
                        <div class="m-0">
                            ...
                            <div class="d-flex flex-stack align-items-end pb-4 mt-n19">
                                ...
                                <form action="{{ route('api.users.update', $user) }}" id="photo-form"
                                      method="POST" class="form" x-data @submit.prevent="$submit()" @then="location.reload()"
                ...
                <div class="tab-content">
                    ...
                    <div id="profile" class="tab-pane active">
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="collapse show">
                                <form action="{{ route('api.users.update', $user) }}" method="POST" class="form" x-data @submit.prevent="$submit()">
                                    @method('PUT')
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-row-bordered align-middle gy-4 gs-9">
                                            ...
                                            <tr>
                                                ...
                                                @if ($user->isBanned())
                                                    <td><span class="badge badge-light-danger">Deactivated</span></td>
                                                    <td>
                                                        @can('create', $user, 'admin')
                                                            <form action="{{ route('api.users.update', $user) }}" method="POST" x-data @submit.prevent="$submit()" @then="location.reload()">
                                                                @method('put')
                                                ...
                                                @else
                                                    ...
                                                    <td>
                                                        @can('create', $user, 'admin')
                                                            <form action="{{ route('api.users.update', $user) }}" method="POST" x-data @submit.prevent="$submit()" @then="location.reload()" data-confirm>
                                                                @method('put')
                                                                <input type="hidden" name="banned_until" value="{{ now()->addCentury() }}">
                                                                <button class="btn btn-danger btn-active-light-primary btn-sm">
                                                                    <i class="fa fa-lock"></i> Deactivate Account
                                                                </button>
                                                            </form>
                                                        @endcan
                                                    </td>
                    ...
                    <div id="change-password" class="tab-pane">
                        <div class="card mb-5 mb-xl-10">
                            ...
                            <div class="collapse show">
                                <!--begin::Form-->
                                <form id="password-form" action="{{ route('api.users.update', $user) }}" method="POST" class="form" x-data @submit.prevent="$submit()" @then="location.reload()">
                                    @method('PUT')
                                    <!--begin::Card body-->
                                    <div class="card-body border-top p-9">
                                        <!--begin::Input group-->
                                    ...
                                    <div class="rounded border border-dashed border-gray-300 p-6 mt-3 mb-10">
                                            <div class="d-md-flex flex-stack">
                                                ...
                                                <div class="text-nowrap">
                                                    <form action="{{ route("api.users.update", $user) }}" @submit.prevent="$submit()"
